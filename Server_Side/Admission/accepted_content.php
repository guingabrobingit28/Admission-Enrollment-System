...
if(isset($_POST['src-submit'])){
    ...
    $result_pending = $admission_list->Search_accepted_admission($search_name);
}else{
    $admission_list = new Show_admission();
    $result_pending = $admission_list->Show_accepted_admission();
}
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="admission_update.php?update_reject=<?php echo $data['admission_id'] ?>"><img class="action-icons cross" src="../../Icons/cross.png"></a>
                            </td>
